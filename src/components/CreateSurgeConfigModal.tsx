...
import { X, Zap, TrendingUp, TrendingDown, AlertCircle } from 'lucide-react';
...
export default function CreateSurgeConfigModal({ isOpen, onClose, onSuccess }: CreateSurgeConfigModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (useTimeWindows && (selectedDays.length > 0 || (startTime && endTime))) {
        body.timeWindows = [
          {
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm font-semibold text-gray-700">Configure specific time windows</span>
                    </label>
                  </div>
